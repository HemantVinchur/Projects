    ...
    <div class="container">
        ...
        <div class="collapse navbar-collapse flex-sm-row-reverse" id="headernav">
            <ul class=" nav navbar-nav menu">
                <li class="nav-item">
                    <a class="nav-link active" href="./Coordinator_Index_Controller">Home</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="./Event_List_Controller"> Events</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="./Event_Controller">Add Event</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="./Coordinator_Student_Contoller">Registered Students</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="./Feedback_Controller">Students Feedback</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link " href="./Coordinator_login">Logout</a>
                </li>
             <!--    <li class="nav-item">
