							...
							<div class="news_body">
								...
								<div class="news_info">
									<ul>
										...
										<!-- Tags -->
										<li><span>in <a href="events.jsp">Events</a></span></li>
										<!-- Comments -->
					...
					<div class="sidebar">
						<div class="tickets">
							...
							<div class="tickets_inner text-center">
								...
								<div class="tickets_next"><a href="events.jsp">See Next Event</a></div>
								<div class="button tickets_button"><a href="register.jsp">Buy Tickets Now!</a></div>
							</div>
						</div>
