	...
	<div class="menu trans_500">
		<div class="menu_content d-flex flex-column align-items-center justify-content-center text-center">
			...
			<ul>
				...
				<li class="menu_item"><a href="news.jsp">Admin</a></li>
				<li class="menu_item"><a href="news.jsp">Event co-ordinator</a></li>
				<li class="menu_item"><a href="news.jsp">Faculty</a></li>
										...
										<div class="header_nav_content d-flex flex-row align-items-center justify-content-start">
											<nav class="main_nav">
												<ul>
													...
													<li><a href="coordinator_login.jsp">Event co-ordinator</a></li>
											...
											<!-- <div class="header_extra ml-auto">
												...
												<div class="button header_button"><a href="/colorlib-regform-5/register1.jsp">Buy Tickets Now!</a></div>
											</div> -->
										</div>
									</div>
								</div>
				...
				<div class="row">
					<div class="col">
						<div class="home_content">
							<div class="home_date">August 25, 2019</div>
							<div class="home_title">	</div>
							<div class="home_location">Hackathon</div>
							<div class="home_text"></div>
							<!-- <div class="home_buttons">
								<div class="button home_button"><a href="/colorlib-regform-5/register1.jsp">Buy Tickets Now!</a></div>
			...
			<div class="row pricing_row">
				...
				<div class="col-lg-4 pricing_col">
					<div class="pricing_item">
						<div class="pricing_item_content">
							<div class="pricing_level"></div>
							<div class="pricing_price">E cell Members</div>
							...
							<div class="button pricing_button"><a href="register.jsp">Book Tickets Now!</a></div>
						</div>
					</div>
				</div>
				...
				<div class="col-lg-4 pricing_col">
					<div class="pricing_item pricing_item_mid">
						<div class="pricing_item_content">
							<div class="pricing_level"></div>
							<div class="pricing_price">Non-Ecell Members</div>
							<ul class="pricing_list">
								<li>3 Conference Tickets</li>
								<li>Vip Table</li>
								<li>Drinks</li>
				...
				<div class="col-lg-4 pricing_col">
					<div class="pricing_item">
						<div class="pricing_item_content">
							<div class="pricing_level"></div>
							<div class="pricing_price">Others</div>
							<ul class="pricing_list">
								<li>3 Conference Tickets</li>
								<li>Vip Table</li>
								<li>Drinks</li>
