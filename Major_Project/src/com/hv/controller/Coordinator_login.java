...
/**
 * Servlet implementation class Coordinator_login
 */
@WebServlet("/Coordinator_login")
public class Coordinator_login extends HttpServlet {
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		RequestDispatcher rd = request.getRequestDispatcher("/coordinator_login.jsp");
